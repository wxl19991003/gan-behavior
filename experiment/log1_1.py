    ...
    for epoch in range(epochs):
        ...
        for i, (x, y) in enumerate(train_loader):
            ...
            if i % 100 == 0:
                ...
                torch.save(model,'log1_CNN_new'+str(lrc)+model.getstr())
...
if __name__ == '__main__':
    ...
    start_time = time()
    acclist31.append(trainandtest(train_loader1, test_loader1, CNN_Net1, loss_func, 0.001, train_dataset1, 50,device))
    acclist31.append(trainandtest(train_loader2, test_loader2, CNN_Net2, loss_func, 0.001, train_dataset1, 50,device))
    acclist31.append(trainandtest(train_loader3, test_loader3, CNN_Net3, loss_func, 0.001, train_dataset1, 50,device))
    print(acclist31)
    end_time=time()
